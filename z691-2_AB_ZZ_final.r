...
#
# Experimento 2A
#PARAM$experimento  <- "ZZ691_2A1"
#PARAM$exp_input  <- "HT651_2A"
#-----------------------------
# Experimento 2B
#PARAM$experimento  <- "ZZ691_2B1"
#PARAM$exp_input  <- "HT651_2B"
#
#
PARAM$modelos  <- 2       #aumentar si se quieren mas modelos
PARAM$semilla  <- 516129  # siempre se debera probar con 5 semillas, en 5 experimentos distintos, y presentar la media y/o los graficos detallados de las cinco curvas si corresponde
