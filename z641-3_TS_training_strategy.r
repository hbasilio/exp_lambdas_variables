...
PARAM  <- list()
PARAM$experimento <- "TS641-3"

PARAM$exp_input  <- "FE6310B"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202002 )
PARAM$final_train  <- c( 201912, 201911, 201910, 201909 )

PARAM$train$training     <- c( 201910, 201909, 201908, 201907 )
PARAM$train$validation   <- c( 201911 )
PARAM$train$testing      <- c( 201912 )
...
PARAM$train$semilla  <- 375149  # cambiar por su propia semilla  !!! 
