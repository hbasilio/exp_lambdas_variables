...
#
# Experimento 3A
#PARAM$experimento  <- "ZZ691_3A1"
#PARAM$exp_input  <- "HT651_3A"
#-----------------------------
# Experimento 3B
#PARAM$experimento  <- "ZZ691_3B1"
#PARAM$exp_input  <- "HT651_3B"
#
#
PARAM$modelos  <- 2       #aumentar si se quieren mas modelos
PARAM$semilla  <- 182109  # siempre se debera probar con 5 semillas, en 5 experimentos distintos, y presentar la media y/o los graficos detallados de las cinco curvas si corresponde
